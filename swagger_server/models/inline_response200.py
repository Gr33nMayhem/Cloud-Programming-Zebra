...
from swagger_server.models.retrieve_all_for_media_sentiment_scores import RetrieveAllForMediaSentimentScores  # noqa: F401,E501
...
class InlineResponse200(Model):
    ...
    """
    def __init__(self, id: str=None, average_magnitude: float=None, sentiment_scores: List[RetrieveAllForMediaSentimentScores]=None):  # noqa: E501
        ...
        :type sentiment_scores: List[RetrieveAllForMediaSentimentScores]
        """
        self.swagger_types = {
            'id': str,
            'average_magnitude': float,
            'sentiment_scores': List[RetrieveAllForMediaSentimentScores]
        }
    ...
    @property
    def sentiment_scores(self) -> List[RetrieveAllForMediaSentimentScores]:
        """Gets the sentiment_scores of this InlineResponse200.


        :return: The sentiment_scores of this InlineResponse200.
        :rtype: List[RetrieveAllForMediaSentimentScores]
        """
        return self._sentiment_scores

    @sentiment_scores.setter
    def sentiment_scores(self, sentiment_scores: List[RetrieveAllForMediaSentimentScores]):
